    ...
    <div class="card-body p-3">
        <div class="row gx-4">
            ...
            <div class="col-auto my-auto">
                <div class="h-100">
                    <h5 class="mb-1">
                    Kirana Sarasvati Ningrum
                    </h5>
                    <p class="mb-0 font-weight-bold text-sm">
                        Manager Front End Designer 
                    </p>
                </div>
            </div>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="text-uppercase text-sm">Educations Information</p>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Educational Institutions</label>
                                <input class="form-control" type="text" value="Institude of Technology Bandung">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Educational Level</label>
                                <input class="form-control" type="text" value="Magister">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Work Experience</label>
                                <input class="form-control" type="text" value="5 years">
                            </div>
                        </div>
                    </div>
                    <hr class="horizontal dark">
