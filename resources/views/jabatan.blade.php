                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Term of Office</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">7 years</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">6,5 years</span>
                                    </td>
                                    <td class="align-middle">
                                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                            Edit
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center">
                                        <span class="text-secondary text-xs font-weight-bold">1 years</span>
                                    </td>
                                    <td class="align-middle">
                                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                            Edit
